...
def test_get_loops_from_annotation():
    ...
    # filtering
    loops = insrtr.get_loops_from_annotation("HHHLLHHHLLLLHHHHLLHHHH", min_length=3)
    assert loops == [[9, 10, 11, 12]]

    #filtering
    loops = insrtr.get_loops_from_annotation("LLLHHHLLHHHLLLLHHHHLLHHHHLLL", min_length=3)
    assert loops == [[12, 13, 14, 15]]

    #filtering at ends
    loops = insrtr.get_loops_from_annotation("LLLHHHLLHHHLLLLHHHHLLHHHHLLL", min_length=3, skip_ends=True)
    assert loops == [[12, 13, 14, 15]]
